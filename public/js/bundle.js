    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51INQEWAXlhFY9gsvzLg4vqvlFHrMApHL2g424yuIHP0ZWiyNux85vcjLvotVnDZraa7zmi3In7rN3gDyoyRREFsj00cwv7SJuT');
            _context.prev = 1;
            _context.next = 4;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmV6emNvIiwiYSI6ImNra3Z2OG5sZDA2NXEydW9ldnQzM3RidDQifQ.MZD8CfEy9AEelTSjcpSqFw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/rezzco/ckkw9mun00dwd17o4juompc3e',
    scrollZoom: false //   center: [-118.263454, 34.023007],
    //   zoom: 7,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // create pop up

    new mapboxgl.Popup({
      offset: 20
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend the map bounds to include new locations
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alert.showAlert)('success', 'Account was created successully!');
            _context.next = 8;
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:8000/api/v1/users/login",
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"utils.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', " your ".concat((0, _utils.Capitalize)(type), " updated successfully!"));
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./utils":"utils.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var userSettingsForm = document.querySelector('.form-user-settings'); // values
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.password-update-btn').textContent = 'save password';
